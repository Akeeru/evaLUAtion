...
// configuration step. It creates a namespace called `evaLUAtion`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", evaLUAtion::cmake::project_name, evaLUAtion::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", evaLUAtion::cmake::project_version);
      return EXIT_SUCCESS;
    }
